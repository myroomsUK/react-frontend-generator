...
export const IterableShowContent = ({ model, record, showElement }) => {
    ...
    if (showElement) {
        ...
        return _jsx(Grid, Object.assign({ container: true }, { children: Array.from(recordsList.values()).map((singleRecord) => _jsx(Grid, Object.assign({ item: true, xs: 12, md: 12 }, { children: _jsx(Grid, Object.assign({ container: true, spacing: 2 }, { children: model.properties.filter(propertyModel => propertyModel.read === true).map(propertyModel => {
